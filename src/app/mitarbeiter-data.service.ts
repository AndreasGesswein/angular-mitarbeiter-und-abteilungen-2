...
constructor(private abteilungDataService: AbteilungDataService) {
  this.mitarbeiter.push(new Mitarbeiter(1, "Andreas", "Gesswein", 3, 3500, abteilungDataService.getAbteilungById(1), "andreasgesswein1@gmail.com", "017683041909", new Date("2002-02-25"), "männlich"));
